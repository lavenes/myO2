...
const Management = (props) => {
    ...
    return (
        <div  className="view management-view">
            <h1 style={{fontSize: 24,color: `rgb(0, 122, 255)`,marginTop: 32}}>Khu vực bạn đang cung cấp Oxy</h1>
            {districts.map((data, i) => {
                if(o2[i].length && findWithAttr(o2[i], 'uid', localStorage.getItem('uid')) > -1) {
                    return (
